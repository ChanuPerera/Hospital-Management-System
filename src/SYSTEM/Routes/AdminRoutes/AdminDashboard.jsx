  ...
  return (
    <div className='w-full h-screen flex flex-row justify-between'>
      ...
      <div className='w-full flex flex-col '>
        ...
        <div className='flex flex-col p-10 justify-start gap-5 items-center w-full overflow-y-auto py-5 lg:w-4/6 sm:w-5/6 bg-[#ffffff] mx-auto' id="style-7">


          <div className='flex flex-row w-full gap-5'>
            <div className='w-1/2 flex flex-row border-[#565656] border-[1px] border-opacity-20 rounded-lg p-5 relative'>
              <div className='flex flex-col space-y-1'>
                <span className='text-[#565656]'>8.30 AM to 10.45 AM </span>
                <span className='text-[#1a1a1a] font-semibold'>Dr. M.P De Silva</span>
                <span className='text-[#a7a7a7]'>Orthopedic  </span>
              </div>

              <div className='text-[12px] text-white font-semibold justify-center
                     items-center absolute top-2 right-2 rounded-s-full px-2 py-1 bg-[#002459]'>
                Room 03
              </div>
            </div>
